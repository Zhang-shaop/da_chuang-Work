        ...
        while not self._event.is_set():
            try:
                ...
                if data=='begin':
                    ...
                    file1 = open('E:/new dachuang/daChuangWork2/server-data/总电压.txt', 'r')
                    trigger1 = file1.read()
                    print('已传递：总电压数据:'+trigger1)
                    datalist.append(trigger1)
                    file1.close()

                    file2 = open('E:/new dachuang/daChuangWork2/server-data/总电流.txt', 'r')
                    trigger2 = file2.read()
                    print('已传递：总电流数据:' + trigger2)
                    datalist.append(trigger2)
                    file2.close()

                    file3 = open('E:/new dachuang/daChuangWork2/server-data/氢槽温度.txt', 'r')
                    trigger3 = file3.read()
                    print('已传递：氢槽温度数据:' + trigger3)
                    datalist.append(trigger3)
                    file3.close()

                    file4 = open('E:/new dachuang/daChuangWork2/server-data/氧槽温度.txt', 'r')
                    trigger4 = file4.read()
                    print('已传递：氧槽温度数据:' + trigger4)
                    datalist.append(trigger4)
                    file4.close()

                    file5 = open('E:/new dachuang/daChuangWork2/server-data/碱液流量.txt', 'r')
                    trigger5 = file5.read()
                    print('已传递：碱液流量数据:' + trigger5)
                    datalist.append(trigger5)
                    file5.close()

                    file6 = open('E:/new dachuang/daChuangWork2/server-data/碱液温度.txt', 'r')
                    trigger6 = file6.read()
                    print('已传递：碱液温度数据:' + trigger6)
                    datalist.append(trigger6)
                    file6.close()

                    file7 = open('E:/new dachuang/daChuangWork2/server-data/1室电压.txt', 'r')
                    trigger7 = file7.read()
                    print('已传递：1室电压数据:' + trigger7)
                    datalist.append(trigger7)
                    file7.close()

                    file8 = open('E:/new dachuang/daChuangWork2/server-data/2室电压.txt', 'r')
                    trigger8 = file8.read()
                    print('已传递：2室电压数据:' + trigger8)
                    datalist.append(trigger8)
                    file8.close()

                    file9 = open('E:/new dachuang/daChuangWork2/server-data/3室电压.txt', 'r')
                    trigger9 = file9.read()
                    print('已传递：3室电压数据:' + trigger9)
                    datalist.append(trigger9)
                    file9.close()

                    file10 = open('E:/new dachuang/daChuangWork2/server-data/4室电压.txt', 'r')
                    trigger10 = file10.read()
                    print('已传递：4室电压数据:' + trigger10)
                    datalist.append(trigger10)
                    file10.close()

                    file11 = open('E:/new dachuang/daChuangWork2/server-data/5室电压.txt', 'r')
                    trigger11 = file11.read()
                    print('已传递：5室电压数据:' + trigger11)
                    datalist.append(trigger11)
                    file11.close()

                    file12 = open('E:/new dachuang/daChuangWork2/server-data/6室电压.txt', 'r')
